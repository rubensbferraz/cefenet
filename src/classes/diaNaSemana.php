...
//------------------------------+
$num = 7;
$diaS_1 = date('d', strtotime("+1 days")); //echo $diaS_1;
$diaS_2 = date('d', strtotime("+2 days")); //echo $diaS_2;
$diaS_3 = date('d', strtotime("+3 days")); //echo $diaS_3;
$diaS_4 = date('d', strtotime("+4 days")); //echo $diaS_4;
$diaS_5 = date('d', strtotime("+5 days")); //echo $diaS_5;
$diaS_6 = date('d', strtotime("+6 days")); //echo $diaS_6;
$diaS_7 = date('d', strtotime("+7 days")); //echo $diaS_7;
